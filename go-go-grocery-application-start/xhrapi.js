...
let requestURL = 'https://sharsha2.github.io/API-Json/go-go-grocery-application-start/dailydeals.json';
...
function dealInfo(jsonObj){ 
  ...
  for (let i = 0; i < dealInfo.length; i++) {
    ...
    image.setAttribute('src', 'https://sharsha2.github.io/API-Json/go-go-grocery-application-start/images/' + dealInfo[i].image);
